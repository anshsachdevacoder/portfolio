        ...
        <form onSubmit={handleDeployCert} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input required type="text" value={title} onChange={(e) => setTitle(e.target.value)} className="w-full bg-brandGray/20 brutal-border border-white/10 p-4 text-sm focus:outline-none focus:border-brandRed transition-colors" placeholder="e.g. AWS Certified Solutions Architect" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input required type="text" value={organization} onChange={(e) => setOrganization(e.target.value)} className="w-full bg-brandGray/20 brutal-border border-white/10 p-4 text-sm focus:outline-none focus:border-brandRed transition-colors" placeholder="e.g. Amazon Web Services" />
            </div>
